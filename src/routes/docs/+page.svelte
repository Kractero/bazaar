<script lang="ts">
	...
	const md = `Bazaar is a backend and frontend wrapper to a database containing all trade records since the start of the nationStates trading card minigame in 2018.
...
<main>
	<div class="flex flex-col items-center justify-center">
		<div class="prose dark:prose-invert mb-40">
